...
/**
 * Presentational LeagueWideRules rules section: renders one already-loaded rules YAML file.
 *
 ...
 */
export function LeagueWideRulesView({ data, darkMode = true }) {
...
export default function LeagueWideRules({ darkMode }) {
  const [data, setData] = useState(null);

  useEffect(() => {
    loadContent('rules/league-wide-rules.yaml').then(setData);
  }, []);

  return <LeagueWideRulesView data={data} darkMode={darkMode} />;
}
