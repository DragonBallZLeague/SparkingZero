...
/**
 * Presentational StaffOnTeamRules rules section: renders one already-loaded rules YAML file.
 *
 ...
 */
export function StaffOnTeamRulesView({ data, darkMode = true }) {
...
export default function StaffOnTeamRules({ darkMode }) {
  const [data, setData] = useState(null);

  useEffect(() => {
    loadContent('rules/staff-on-team-rules.yaml').then(setData);
  }, []);

  return <StaffOnTeamRulesView data={data} darkMode={darkMode} />;
}
