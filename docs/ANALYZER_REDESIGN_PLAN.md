...
- Default selection is now `'latest-season'`, resolved against the loaded tree at runtime (`resolveLatestSeasonFolder`) so it never needs updating when a new season starts.
